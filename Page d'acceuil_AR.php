...
<table width="1257" border="0" cellspacing="0" cellpadding="0">
  ...
  $fp = fopen("index_Script/compteur.txt","r+");
    ...
    <td width="1012" height="108" align="left" valign="top" bgcolor="#0099FF" id="tagline"><table width="1003" height="135" border="0" cellpadding="0" cellspacing="0" id="leftcol">
      <tr>
      ...
      <tr valign="top">
        ...
        <td width="455" bgcolor="#0099FF" class="navText Style9"><p><span class="Style116"><u><span class="Style110">D&eacute;riger</span> Par</u>:</span></p>          </td>
      </tr>
      <tr>
  ...
  <tr>
    <td height="27" colspan="2" align="left" bgcolor="#FAFAFA"><p class="Style147"><span class="Style163"><span class="Style164">&gt;Page d'accuei</span></span><span class="Style164">l</span></p>
    </td>
    <td height="27" align="center" bgcolor="#FAFAFA"> <p>&nbsp;</p>
      ...
      <table width="961" height="31" border="0">
        ...
        <tr>
          ...
          <td width="285" align="center" bgcolor="#99CCFF" class="Style149"><a href="Page d'acceuil_EN.php">In English (EN) </a></td>
          <td width="10" align="center">&nbsp;</td>
          <td width="239" align="center" bgcolor="#99CCFF" class="Style149"><a href="#">بالعربية</a></td>
...
href="Recherche par Sous Domaine.php">SOUS-DOMAINE </A></span> </div>
                ...
                <DIV class="Style99" onmouseover=montre(this.childNodes[2]) 
onmouseout=cache(this.childNodes[2])>
                  <p><A href="Un.php">AJOUTER</A>                </p>
                  <p>&nbsp;</p>
                </DIV>
                <DIV class="Style99" onmouseover=montre(this.childNodes[2]) 
onmouseout=cache(this.childNodes[2])>
                  <p><A class=autremenu 
href="#">STATISTIQUES</A> </p>
                  <p>&nbsp;</p>
                </DIV>
                <DIV class="Style99" onmouseover=montre(this.childNodes[2]) 
onmouseout=cache(this.childNodes[2])>
...
href="#">Mon Adresse</A></DIV>
                    <DIV><A 
href="#">Envoyer Un Comentaires  </A></DIV>
                    <DIV></DIV>
                  </DIV>
                </DIV>
                <DIV>
   ...
   <td width="10" rowspan="2" valign="top" bgcolor="#FFFFFF"><p>&nbsp;</p>
    <p>&nbsp;</p></td>
